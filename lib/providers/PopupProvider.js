    ...
    value: function render() {
      ...
      _react2.default.Children.forEach(children, function (child) {
        _react2.default.Children.forEach(child.props.children, function (child2) {
          ...
          var open = !!currentPopup || !!child2.props.open;

          var clonedElement = _react2.default.cloneElement(child2, { open: open, params: params });
          if (popup && Object.keys(popup).findIndex(function (name) {
            return name === clonedElement.props.name;
          }) !== -1 || clonedElement.props && clonedElement.props.open) {
